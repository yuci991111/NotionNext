...
const BLOG = {
  AUTHOR: '鱼刺', // 作者
  BIO: '好多🐟', // 作者简介
  LINK: 'https://b.yyuci.net/', // 网站地址
  KEYWORDS: '鱼刺不刺鱼, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '5f36e458687344d2ab165facda48d511', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'yucibuciyu@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/yuci991111',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'yuci991111/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'yuci991111/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '鱼刺不刺鱼', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
